...
def loadData (event_url, event_org):
    ...
    for x in range (2, row_len+1):
      ...
      event_name_array = tree.xpath('//*[@id="recent_tab"]/table/tr[%i]/td[2]/a/span/text()'%(x))
      # event_parse = re.sub('[-.]', '', event_name_array)
      event_name.append(event_name_array)
      # scrape event month
      event_month_array = tree.xpath('//*[@id="recent_tab"]/table/tr[%i]/td[1]/span/span[1]/text()'%(x))
      event_month.append(event_month_array)
      # scrape event day
      event_day_array = tree.xpath('//*[@id="recent_tab"]/table/tr[%i]/td[1]/span/span[2]/text()'%(x))
      event_day.append(event_day_array)
      # scrape event year
      event_year_array = tree.xpath('//*[@id="recent_tab"]/table/tr[%i]/td[1]/span/span[3]/text()'%(x))
      event_year.append(event_year_array)
      # scrape event fight card URL
      event_fight_card_url_array = tree.xpath('//*[@id="recent_tab"]/table/tr[%i]/td[2]/a/@href'%(x))
      ev_fc_wbst = 'http://www.sherdog.com', ''.join(event_fight_card_url_array)
      event_fight_card_url.append(ev_fc_wbst)
      event_location_array = tree.xpath('//*[@id="recent_tab"]/table/tr[%i]/td[3]/text()'%(x))
...
event_url = 'https://www.sherdog.com/organizations/Ultimate-Fighting-Championship-2/recent-events/5'
#reset the event id
event_id = 0
...
# set the event url to sherdog ufc section
# event_url = 'http://www.sherdog.com/organizations/Ultimate-Fighting-Championship-2'
event_url = 'https://www.sherdog.com/organizations/Ultimate-Fighting-Championship-2/recent-events/4'
#reset the event id
#event_id = 0
...
# set the event url to sherdog ufc section
# event_url = 'http://www.sherdog.com/organizations/Ultimate-Fighting-Championship-2'
event_url = 'https://www.sherdog.com/organizations/Ultimate-Fighting-Championship-2/recent-events/3'
#reset the event id
# event_id = 0
...
# set the event url to sherdog ufc section
# event_url = 'http://www.sherdog.com/organizations/Ultimate-Fighting-Championship-2'
#event_url = 'http://www.sherdog.com/organizations/Ultimate-Fighting-Championship-2/recent-events/2'
event_url = 'https://www.sherdog.com/organizations/Ultimate-Fighting-Championship-UFC-2/recent-events/2'
#reset the event id
#event_id = 0
...
# set the event url to sherdog ufc section
# event_url = 'http://www.sherdog.com/organizations/Ultimate-Fighting-Championship-2'
event_url = 'https://www.sherdog.com/organizations/Ultimate-Fighting-Championship-UFC-2/recent-events/1'
#reset the event id
# event_id = 0
...
print "*********************************************"
print "UFC Upcoming Section Scrape Page 1..."
print "*********************************************"
# set the event organization to UFC
event_org = 'UFC'
# set the event url to sherdog ufc section
# event_url = 'http://www.sherdog.com/organizations/Ultimate-Fighting-Championship-2'
event_url = 'https://www.sherdog.com/organizations/Ultimate-Fighting-Championship-2/upcoming-events/1'
#reset the event id
# event_id = 0
...
event_url = 'https://www.sherdog.com/organizations/Bellator-MMA-1960/recent-events/3'
# set the event organization to Bellator
event_org = 'Bellator'

# Load the Bellator Data
bellator_row_len = loadData(event_url, event_org)
...
# event_id = 0
# set the event url to sherdog bellator section
event_url = 'https://www.sherdog.com/organizations/Bellator-MMA-1960/recent-events/2'
# set the event organization to Bellator
event_org = 'Bellator'
...
print "*********************************************"
print "Bellator Section Scrape..."
print "*********************************************"
# reset the event id
# event_id = 0
# set the event url to sherdog bellator section
event_url = 'https://www.sherdog.com/organizations/Bellator-MMA-1960/recent-events/1'
# set the event organization to Bellator
event_org = 'Bellator'
...
# event_id = 0
# set the event url to sherdog bellator section
event_url = 'https://www.sherdog.com/organizations/Bellator-MMA-1960/upcoming-events/1'
# set the event organization to Bellator
event_org = 'Bellator'
...
# print "*********************************************"
# print "WSOF Section Scrape..."
# print "*********************************************"
# reset the event id
# event_id = 0
# set the event url to sherdog wsof section
# event_url = 'http://www.sherdog.com/organizations/World-Series-of-Fighting-5449'
# set the event organization to wsof
# event_org = 'WSOF'

#load the wsof data
# wsof_row_len = loadData(event_url, event_org)

# insert the wsof data
# insertRows(wsof_row_len, prev_row_ptr, array_pos)
