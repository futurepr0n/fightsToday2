...
###### WORKING ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
	...
	for z in range(2, row_len):
		...
		# scrape fighter one name
		fighter_one_array = tree.xpath('/html/body/div[3]/div[2]/div[1]/section[2]/div/div/table/tbody/tr[%i]/td[2]/a/span/name/text()'%(z))  
		...
		fighter_one_url_array = tree.xpath('/html/body/div[2]/div[2]/div[1]/section[2]/div/div/table/tbody/tr[%i]/td[2]/a/@href'%(z))
		...
		fighter_two_array = tree.xpath('/html/body/div[2]/div[2]/div[1]/section[2]/div/div/table/tbody/tr[%i]/td[4]/a/span/text()'%(z))
		...
		fighter_two_url_array = tree.xpath('/html/body/div[2]/div[2]/div[1]/section[2]/div/div/table/tbody/tr[%i]/td[4]/a/@href'%(z))
