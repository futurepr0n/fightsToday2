...
def insertRows (row_len, prev_row_ptr, array_pos):
    ...
    for loopid in range (0,row_len-1):
     ...
     # print '+++++++++++++++++++++++++++++'
      ...
      #print '+++++++++++++++++++++++++++++'
      #print '+++++++++++++++++++++++++++++'
      query = "INSERT INTO mma_events_wiki (event_name, event_id, event_fight_card_url, event_org, event_date) VALUES (\"%s\",%i,\"%s\",\"%s\",\"%s\")"%(db_e_en, event_id, db_e_fc, event_org,db_e_fd)
      #print query
